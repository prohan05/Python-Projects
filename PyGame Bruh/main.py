...
BULLET_HIT_SOUND = pygame.mixer.Sound('C:\\Users\\proha\\OneDrive\\Desktop\\Projects\\PyGame Bruh\\Assets\\Bruh.wav')
BULLET_FIRE_SOUND = pygame.mixer.Sound('C:\\Users\\proha\\OneDrive\\Desktop\\Projects\\PyGame Bruh\\Assets\\Pew Pew.wav')

YELLOW_HIT = pygame.USEREVENT + 1
RED_HIT = pygame.USEREVENT + 2
SPACESHIP_W, SPACESHIP_H = 55, 40
YELLOW_SPACESHIP_IMAGE = pygame.image.load(os.path.join('Assets', 'spaceship_yellow.png'))
YELLOW_SPACESHIP = pygame.transform.rotate(pygame.transform.scale(YELLOW_SPACESHIP_IMAGE, (SPACESHIP_W, SPACESHIP_H)),
                                           90)
...
def yellow_handle_movement(keys_pressed, yellow):
    if keys_pressed[pygame.K_a] and yellow.x - VEL + 5 > 0:  # LEFT
        yellow.x -= VEL
...
def red_handle_movement(keys_pressed, red):
    if keys_pressed[pygame.K_LEFT] and red.x - VEL - 10 > BORDER.x:  # LEFT
        red.x -= VEL
    if keys_pressed[pygame.K_RIGHT] and red.x + VEL + red.width < 900 + 20:  # RIGHT
        red.x += VEL
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_LCTRL and len(yellow_bullets) < MAX_BULLETS:
                    bullet = pygame.Rect(yellow.x + yellow.width, 8 + yellow.y + yellow.height // 2 - 2, 10, 5)
                    yellow_bullets.append(bullet)
                    BULLET_FIRE_SOUND.play()
                if event.key == pygame.K_RCTRL and len(red_bullets) < MAX_BULLETS:
                    bullet = pygame.Rect(red.x, 8 + red.y + red.height // 2 - 2, 10, 5)
